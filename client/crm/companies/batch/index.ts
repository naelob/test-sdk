...
/**
 * Builds and executes requests for operations under /crm/companies/batch
 */
export interface BatchRequestBuilder extends BaseRequestBuilder<BatchRequestBuilder> {
     ...
     */
     post(body: UnifiedCompanyInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : Promise<BatchPostResponse | undefined>;
    /**
     * Add a batch of Companies
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UnifiedCompanyInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * Add a batch of Companies
 */
...
export function deserializeIntoBatchPostResponse(batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "data": n => { batchPostResponse.data = n.getObjectValue<UnifiedCompanyOutput>(createUnifiedCompanyOutputFromDiscriminatorValue); },
    }
}
/**
...
export function serializeBatchPostResponse(writer: SerializationWriter, batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : void {
    ...
    writer.writeObjectValue<UnifiedCompanyOutput>("data", batchPostResponse.data, serializeUnifiedCompanyOutput);
}
/**
 ...
 */
export const BatchRequestBuilderUriTemplate = "{+baseurl}/crm/companies/batch{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
