...
/**
 * Builds and executes requests for operations under /crm/tasks/batch
 */
export interface BatchRequestBuilder extends BaseRequestBuilder<BatchRequestBuilder> {
     ...
     */
     post(body: UnifiedTaskInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : Promise<BatchPostResponse | undefined>;
    /**
     * Add a batch of Tasks
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UnifiedTaskInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * Add a batch of Tasks
 */
...
export function deserializeIntoBatchPostResponse(batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "data": n => { batchPostResponse.data = n.getObjectValue<UnifiedTaskOutput>(createUnifiedTaskOutputFromDiscriminatorValue); },
    }
}
/**
...
export function serializeBatchPostResponse(writer: SerializationWriter, batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : void {
    ...
    writer.writeObjectValue<UnifiedTaskOutput>("data", batchPostResponse.data, serializeUnifiedTaskOutput);
}
/**
 ...
 */
export const BatchRequestBuilderUriTemplate = "{+baseurl}/crm/tasks/batch{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
