...
/**
 * Builds and executes requests for operations under /crm/contacts/batch
 */
export interface BatchRequestBuilder extends BaseRequestBuilder<BatchRequestBuilder> {
     ...
     */
     post(body: UnifiedContactInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : Promise<BatchPostResponse | undefined>;
    /**
     * Add a batch of CRM Contacts
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UnifiedContactInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * Add a batch of CRM Contacts
 */
...
export function deserializeIntoBatchPostResponse(batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "data": n => { batchPostResponse.data = n.getObjectValue<UnifiedContactOutput>(createUnifiedContactOutputFromDiscriminatorValue); },
    }
}
/**
...
export function serializeBatchPostResponse(writer: SerializationWriter, batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : void {
    ...
    writer.writeObjectValue<UnifiedContactOutput>("data", batchPostResponse.data, serializeUnifiedContactOutput);
}
/**
 ...
 */
export const BatchRequestBuilderUriTemplate = "{+baseurl}/crm/contacts/batch{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
