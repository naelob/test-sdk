...
/**
 * Builds and executes requests for operations under /crm/deals/batch
 */
export interface BatchRequestBuilder extends BaseRequestBuilder<BatchRequestBuilder> {
     ...
     */
     post(body: UnifiedDealInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : Promise<BatchPostResponse | undefined>;
    /**
     * Add a batch of Deals
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UnifiedDealInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * Add a batch of Deals
 */
...
export function deserializeIntoBatchPostResponse(batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "data": n => { batchPostResponse.data = n.getObjectValue<UnifiedDealOutput>(createUnifiedDealOutputFromDiscriminatorValue); },
    }
}
/**
...
export function serializeBatchPostResponse(writer: SerializationWriter, batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : void {
    ...
    writer.writeObjectValue<UnifiedDealOutput>("data", batchPostResponse.data, serializeUnifiedDealOutput);
}
/**
 ...
 */
export const BatchRequestBuilderUriTemplate = "{+baseurl}/crm/deals/batch{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
