...
/**
 * Builds and executes requests for operations under /ticketing/contacts/{id}
 */
 ...
 */
export const ContactsItemRequestBuilderUriTemplate = "{+baseurl}/ticketing/contacts/{id}{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
