...
/**
 * Builds and executes requests for operations under /ticketing/users/{id}
 */
 ...
 */
export const UsersItemRequestBuilderUriTemplate = "{+baseurl}/ticketing/users/{id}{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
