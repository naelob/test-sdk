...
/**
 * Builds and executes requests for operations under /ticketing/tickets/batch
 */
export interface BatchRequestBuilder extends BaseRequestBuilder<BatchRequestBuilder> {
     ...
     */
     post(body: UnifiedTicketInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : Promise<BatchPostResponse | undefined>;
    /**
     * Add a batch of Tickets
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UnifiedTicketInput[], requestConfiguration?: RequestConfiguration<BatchRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * Add a batch of Tickets
 */
...
export function deserializeIntoBatchPostResponse(batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "data": n => { batchPostResponse.data = n.getObjectValue<UnifiedTicketOutput>(createUnifiedTicketOutputFromDiscriminatorValue); },
    }
}
/**
...
export function serializeBatchPostResponse(writer: SerializationWriter, batchPostResponse: Partial<BatchPostResponse> | undefined = {}) : void {
    ...
    writer.writeObjectValue<UnifiedTicketOutput>("data", batchPostResponse.data, serializeUnifiedTicketOutput);
}
/**
 ...
 */
export const BatchRequestBuilderUriTemplate = "{+baseurl}/ticketing/tickets/batch{?remote_data*}";
/* tslint:enable */
/* eslint-enable */
