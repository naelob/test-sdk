...
exports.MultipartSerializationWriter = void 0;
...
class MultipartSerializationWriter {
    constructor() {
        ...
        this.writeObjectValue = (key, value, serializerMethod) => {
            ...
            if (!(value instanceof kiota_abstractions_1.MultipartBody)) {
...
exports.MultipartSerializationWriter = MultipartSerializationWriter;
