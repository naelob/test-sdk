...
class TextParseNode {
    ...
    constructor(text) {
        ...
        this.getGuidValue = () => (0, kiota_abstractions_1.parseGuidString)(this.text);
        ...
        this.getEnumValue = (type) => {
            return type[(0, kiota_abstractions_1.toFirstCharacterUpper)(this.text)];
        };
        if (this.text &&
            this.text.length > 1 &&
            this.text.charAt(0) === '"' &&
