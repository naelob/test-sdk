...
class TimeOnly {
     ...
     */
    toString() {
        return `${(0, dateOnly_1.formatSegment)(this.hours, 2)}:${(0, dateOnly_1.formatSegment)(this.minutes, 2)}:${(0, dateOnly_1.formatSegment)(this.seconds, 2)}.${(0, dateOnly_1.formatSegment)(this.picoseconds, 12)}`;
    }
}
