...
exports.createMessageFromDiscriminatorValue = exports.deserializeIntoMultipartBody = exports.serializeMultipartBody = exports.MultipartBody = void 0;
...
class MultipartBody {
    ...
    constructor() {
        this._parts = {};
        this._boundary = guid_typescript_1.Guid.create().toString().replace(/-/g, "");
    }
    /**
...
exports.serializeMultipartBody = serializeMultipartBody;
function deserializeIntoMultipartBody(
// eslint-disable-next-line @typescript-eslint/no-unused-vars
_ = new MultipartBody()) {
    throw new Error("Not implemented");
}
exports.deserializeIntoMultipartBody = deserializeIntoMultipartBody;
function createMessageFromDiscriminatorValue(parseNode) {
    if (!parseNode)
        throw new Error("parseNode cannot be undefined");
    return deserializeIntoMultipartBody;
}
exports.createMessageFromDiscriminatorValue = createMessageFromDiscriminatorValue;
